...
export class PompePistoletService {
  ...
  addPompe(pompeData: any): Observable<any> {
    return this.http
      .post(`${this.pompeUrl}/pompes`, pompeData, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  updatePompe(id: number, pompeData: any): Observable<any> {
    return this.http
      .put(`${this.pompeUrl}/pompes/${id}`, pompeData, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  deletePompe(id: number): Observable<any> {
    return this.http
      .delete(`${this.pompeUrl}/pompes/${id}`, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  addPistolet(data: {
    ...
    return this.http
      .post(`${this.pistoletUrl}/add`, data, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  getPistoletsByPompeId(pompeId: number): Observable<any> {
    return this.http
      .get(`${this.pistoletUrl}/pompe/${pompeId}`, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  updateStatutPistolet(pistoletId: number, statut: string): Observable<any> {
    return this.http
      .put(
        `${this.pistoletUrl}/update-statut`,
        {
          id: pistoletId,
          statut,
        },
  ...
  enregistrerReleve(data: {
    ...
    return this.http
      .post(`${this.pistoletUrl}/releves`, data, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  ajouterReleveManuel(data: {
    ...
    return this.http
      .post(`${this.pistoletUrl}/releves/manuel`, data, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  genererRapportJournalier(date: string | Date): Observable<any> {
    ...
    return this.http
      .post(
        `${this.pistoletUrl}/rapports/generer`,
        { date: dateStr },
        {
          headers: this.getAuthHeaders(),
          withCredentials: true,
  ...
  ajouterRapportManuel(data: {
    ...
    return this.http
      .post(`${this.pistoletUrl}/rapports/manuel`, data, {
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
      .pipe(catchError(this.handleError));
  ...
  getHistoriqueReleves(
    pistoletId: number | null,
    dateDebut: string,
    dateFin: string
  ): Observable<any> {
    // Vérification des paramètres obligatoires
    if (!dateDebut || !dateFin) {
      return throwError(() => new Error('Les dates sont obligatoires'));
    }

    // Construction de l'URL
    let url = `${this.pistoletUrl}`;

    // Ajout du pistolet_id seulement si fourni
    if (pistoletId) {
      url += `/${pistoletId}`;
    }
    ...
    // Paramètres de requête (toujours les dates)
  ...
  getRevenusJournaliers(
    ...
    return this.http
      .get(`${this.pistoletUrl}/revenus-journaliers`, {
        params,
        headers: this.getAuthHeaders(),
        withCredentials: true,
      })
  ...
  updateIndexOuverture(pistoletId: number, index: number): Observable<any> {
    return this.http
      .put(
        `${this.pistoletUrl}/update-ouverture`,
        {
          id: pistoletId,
  ...
  updateIndexFermeture(pistoletId: number, index: number): Observable<any> {
    return this.http
      .put(
        `${this.pistoletUrl}/update-fermeture`,
        {
          id: pistoletId,
